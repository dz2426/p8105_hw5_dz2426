...
sim_result_beta1s = 
  tibble(beta1s = c(1:6)) %>% 
  mutate(
    output_list = map(.x = beta1s, ~rerun(30, sim_regression(n = 30, beta1 = .x))), 
...
**Comments:**  
The plot shows that the power of the test has a positive association with effect size. The positive gradient decreases as effect size increases.
